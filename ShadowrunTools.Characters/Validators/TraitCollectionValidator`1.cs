namespace ShadowrunTools.Characters.Validators
{
    ...
    public class TraitCollectionValidator<T> : ItemChangedBase, IValidatorItem, IDisposable
        where T : class, ITrait
    {
        ...
        public TraitCollectionValidator(
        ...
        private void OnCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            {
                _isValidMap[kvp.Key] = _validation(kvp.Value as T);
                kvp.Value.ItemChanged += OnTraitChanged;
            }
